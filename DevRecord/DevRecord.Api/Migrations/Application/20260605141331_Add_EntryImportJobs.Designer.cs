...
namespace DevRecord.Api.Migrations.Application
{
    ...
    [Migration("20260605141331_Add_EntryImportJobs")]
...
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("dev_record")
                .HasAnnotation("ProductVersion", "9.0.11")
                .HasAnnotation("Relational:MaxIdentifierLength", 63);

            NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);

            modelBuilder.Entity("DevRecord.Api.Entities.Entry", b =>
                {
                    ...
                    b.ToTable("entries", "dev_record");
                });

            modelBuilder.Entity("DevRecord.Api.Entities.EntryImportJob", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("entry_import_jobs", "dev_record");
                });

            modelBuilder.Entity("DevRecord.Api.Entities.GitHubAccessToken", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("git_hub_access_tokens", "dev_record");
                });

            modelBuilder.Entity("DevRecord.Api.Entities.Habit", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("habits", "dev_record");
                });

            modelBuilder.Entity("DevRecord.Api.Entities.HabitTag", b =>
                {
                    b.Property<string>("HabitId")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("habit_tags", "dev_record");
                });

            modelBuilder.Entity("DevRecord.Api.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("tags", "dev_record");
                });

            modelBuilder.Entity("DevRecord.Api.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("users", "dev_record");
                });

            modelBuilder.Entity("DevRecord.Api.Entities.Entry", b =>
                {
                    b.HasOne("DevRecord.Api.Entities.Habit", "Habit")
                        .WithMany()
                    ...
                    b.HasOne("DevRecord.Api.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DevRecord.Api.Entities.GitHubAccessToken", b =>
                {
                    b.HasOne("DevRecord.Api.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("DevRecord.Api.Entities.GitHubAccessToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DevRecord.Api.Entities.Habit", b =>
                {
                    ...
                    b.OwnsOne("DevRecord.Api.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevRecord.Api.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevRecord.Api.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("DevRecord.Api.Entities.HabitTag", b =>
                {
                    b.HasOne("DevRecord.Api.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("DevRecord.Api.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
