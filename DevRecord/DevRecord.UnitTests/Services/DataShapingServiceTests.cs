...
public sealed class DataShapingServiceTests
{
    ...
    [Fact]
    public void ShapeData_ShouldReturnAllProperties_WhenFieldsAreEmpty()
    {
        var entity = new TestDto { Id = "1", Name = "Test", Description = "Desc", Value = 42 };
        ExpandoObject result = _dataShapingService.ShapeData(entity, "");
        IDictionary<string, object?> dict = result;
        Assert.Equal(4, dict.Count);
    }

    [Fact]
    public void ShapeData_ShouldIncludeNullProperties_WhenFieldsAreNull()
    {
        var entity = new TestDto { Id = "1", Name = "Test", Description = null, Value = 42 };
        ExpandoObject result = _dataShapingService.ShapeData(entity, null);
        IDictionary<string, object?> dict = result;
    ...
    [Fact]
    public void ShapeCollectionData_ShouldReturnEmptyList_WhenCollectionIsEmpty()
    {
        List<ExpandoObject> result = _dataShapingService.ShapeCollectionData(
            new List<TestDto>(), null);
        Assert.Empty(result);
    }
}
