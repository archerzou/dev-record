...
public sealed class StoreGitHubAccessTokenDtoValidatorTests
{
    ...
    [Fact]
    public async Task Validate_ShouldReturnError_WhenAccessTokenExceedsMaxLength()
    {
        // Arrange
        var dto = new StoreGitHubAccessTokenDto
        {
            AccessToken = new string('a', 256),
            ExpiresInDays = 30
        };
    ...
    [Fact]
    public async Task Validate_ShouldReturnError_WhenExpiresInDaysIsZero()
    {
        // Arrange
        var dto = new StoreGitHubAccessTokenDto
        {
    ...
    [Fact]
    public async Task Validate_ShouldReturnError_WhenExpiresInDaysExceedsMaximum()
    {
        // Arrange
        var dto = new StoreGitHubAccessTokenDto
        {
    ...
    [Fact]
    public async Task Validate_ShouldNotReturnError_WhenExpiresInDaysIsExactlyMaximum()
    {
        // Arrange
        var dto = new StoreGitHubAccessTokenDto
        {
            AccessToken = "gho_valid_access_token",
            ExpiresInDays = 365 // exactly 365 = valid
        };
