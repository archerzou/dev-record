...
public sealed class CreateHabitDtoValidatorTests
{
    ...
    [Fact]
    public async Task Validate_ShouldNotReturnError_WhenNameIsExactlyMinLength()
    {
        var dto = new CreateHabitDto
        {
            Name = "abc", // exactly 3
    ...
    [Fact]
    public async Task Validate_ShouldNotReturnError_WhenBinaryHabitHasValidUnit()
    {
        var dto = new CreateHabitDto
        {
            Name = "Read Books",
    ...
    [Fact]
    public async Task Validate_ShouldNotReturnError_WhenEndDateIsNull()
    {
        var dto = new CreateHabitDto
        {
            Name = "Read Books",
    ...
    public async Task Validate_ShouldReturnError_WhenMilestoneTargetIsZero()
    {
        ...
        var dto = new CreateHabitDto
        {
            ...
            Milestone = new CreateMilestoneDto
            {
                Target = 0
            }
        };
    ...
    [Fact]
    public async Task Validate_ShouldNotReturnError_WhenMilestoneIsNull()
    {
        var dto = new CreateHabitDto
        {
            Name = "Read Books",
    ...
    [Fact]
    public async Task Validate_ShouldNotReturnError_WhenAutomationSourceIsGitHub()
    {
        var dto = new CreateHabitDto
        {
            Name = "Daily Commits",
